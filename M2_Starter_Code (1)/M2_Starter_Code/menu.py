...
while place_order:
    ...
    menu_category = input("Choose menu number: ")
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            while True:
                ...
                menu_selection = input("Choose your menu number: ")
                ...
                if menu_selection.isdigit():
                    ...
                    if menu_selection in menu_items:
                        ...
                        while True:
                            ...
                            # Ask if they want to add more of the same type or variation
                            more_variation = input(f"Would you like to add more variations of {item_name}? (Y)es or (N)o ")
                            if more_variation.lower() != 'y':
                                break
                    else:
                ...
                # Ask if they want to select another item from the same category
                more_items = input(f"Would you like to order another item from {menu_category_name}? Yes or No ")
    ...
    while True:
        ...
        if keep_ordering.lower() == 'yes':
            # Keep ordering
            break
        elif keep_ordering.lower() == 'no':
            # Complete the order
            place_order = False
            # Since the customer decided to stop ordering, thank them for
            # their order
            print("Thank you for your Order See Ya!!.")
            break
        else:
...
print("This is your following order.\n")
